// ============================================================
// Shell v4 — shadcn-style rounded sidebar + minimal topbar
// ============================================================
...
function Sidebar({ current, navigate, credits, onAuthLogout }) {
  return (
    <aside className="sb">
...
function Topbar({ current, theme, setTheme, lang, setLang, onOpenPalette, onOpenNotifs, sbHidden, onToggleSb }) {
  return (
    <header className="tb">
      <button className="tb-icon" onClick={onToggleSb} aria-label={sbHidden ? 'Afficher le menu' : 'Masquer le menu'} title={sbHidden ? 'Afficher le menu' : 'Masquer le menu'}>
...
function CommandPalette({ open, onClose, navigate, setTheme, theme }) {
...
function SidebarFab({ collapsed, onToggle }) { return null; }

window.Sidebar = Sidebar;
window.Topbar = Topbar;
window.CommandPalette = CommandPalette;
window.NotifPanel = NotifPanel;
window.SidebarFab = SidebarFab;
